...
#region OpenGL identifiers
    ...
    public static class Raylib
    {
        ...
        {
            return Utils.PtrToStringUTF8(INTERNAL_GetMonitorName(monitor));
        }
        ...
        {
            return Utils.PtrToStringUTF8(INTERNAL_GetClipboardText());
        }
        ...
        {
            return Utils.PtrToStringUTF8(INTERNAL_GetGamepadName(gamepad));
        }
